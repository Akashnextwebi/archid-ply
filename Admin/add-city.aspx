<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="add-city.aspx.cs" Inherits="Admin_add_city" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><%=Request.QueryString["id"] !=null?"Update":"Add" %>  City</h5>
                        </div>
                        <div class="card-body">
                            <div class="row gy-4">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Manage Cities</h4>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
    ...
    <script src="assets/js/pages/add-city.js"></script>
</asp:Content>
