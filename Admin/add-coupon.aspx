                     ...
                     <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <asp:TextBox runat="server" MaxLength="6" placeHolder="Enter Coupon Value" class="form-control mb-2 mr-sm-2 decimalInput" ID="txtValue" />
                             ...
                             <div class="col-lg-4 mb-3">
                                ...
                                <asp:TextBox runat="server"  placeHolder="Expiry Date"  class="form-control mb-2 mr-sm-2 datepickerCurrent flatpickr-input" ID="txtDate" />
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                <asp:TextBox runat="server" MaxLength="50" placeHolder="Expiry Date" class="form-control mb-2 mr-sm-2" ID="txtCode" />
                             ...
                             <div class="col-lg-3 mb-3">
                                <label>Minimum Cart Value<sup>*</sup></label>
                            ...
                            <div class="col-lg-12 mb-3">
                                <label>Coupon description<sup>*</sup></label>
