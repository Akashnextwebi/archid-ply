$(document).ready(function () {
    $(document.body).on('click', '.deleteItem', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'POST',
                    url: "view-products-stories.aspx/Delete",
                    data: "{id: '" + id + "'}",
    ...
    $(document.body).on("click", "#AddToGallery", function () {
        ...
        $.ajax({
            url: "product-stories-images.ashx",
            type: "POST",
            data: data,
            contentType: false,
            processData: false,
    ...
    $(document.body).on('click', '.deleteGalleryItem', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'POST',
                    url: "view-products-stories.aspx/DeletePackageGallery",
                    data: "{id: '" + id + "'}",
                    contentType: 'application/json; charset=utf-8',
                    dataType: "json",
                    async: false,
...
function BindGalleryImages(id) {
    $.ajax({
        type: 'POST',
        url: "view-products-stories.aspx/GetGalleryImage",
        data: "{id: '" + id + "'}",
        contentType: 'application/json; charset=utf-8',
        dataType: "json",
        async: false,
        success: function (data2) {
            ...
            for (var i = 0; i < lnt.length; i++) {
                ...
                del += "<a href='javascript:void(0);' class='bs-tooltip btn btn-danger  deleteGalleryItem mt-3' data-id='" + lnt[i].Id + "' data-pid='" + lnt[i].vehicleId + "' data-toggle='tooltip' data-placement='top' title='' data-original-title='Delete'>";
...
function ArrengeCategory(product) {
    ...
    $.ajax({
        type: 'POST',
        url: "view-products-stories.aspx/ImageOrderUpdate",
