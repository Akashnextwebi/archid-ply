<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="manage-our-reports.aspx.cs" Inherits="Admin_manage_our_reports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Our reports</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Our reports</a></li>
                                <li class="breadcrumb-item active">Manage Our reports</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><%=Request.QueryString["id"] !=null?"Update":"Add" %> Our reports</h5>
                        </div>
                        <div class="card-body">
                            <div class="row gy-4">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Manage Our reports </h4>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
    ...
    <script src="assets/js/pages/manage-our-reports.js"></script>
</asp:Content>
