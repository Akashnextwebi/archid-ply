                        ...
                        <div class="card-body">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpValidator1" runat="server" ControlToValidate="txtEmail" Display="Dynamic" ValidationGroup="Save" ForeColor="Red" SetFocusOnError="true" ErrorMessage="Invalid E-mail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
