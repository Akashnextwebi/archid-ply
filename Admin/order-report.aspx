...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class='shippingAddress_ul'>
                        <li>
                            <strong>Business Name : </strong><span id="txtBusinessName"></span>
                        </li>
                        <li>
    ...
    <div class="modal fade" id="DeliveryModal" data-orderguid="" tabindex="-1" aria-labelledby="exampleModalgridLabel1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-12">
                        <div class="hstack gap-2 justify-content-end">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                            <button type="button" id="btnDelDate" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </div>
                <!--end col-->
