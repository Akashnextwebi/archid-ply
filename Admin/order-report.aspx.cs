...
public partial class order_report : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (order.Rows.Count > 0)
            {
                for (int i = 0; i < order.Rows.Count; i++)
                {
                    ...
                    {
                        pSts = "<span class='badge badge-soft-danger badge-border'>Not Paid</span>";
                    }
                    ...
                    strReport += @"<tr>
                                    ...
                                    <a href='javascript:void(0);' data-id='" + OrderGuid + @"' data-Name='" + HttpUtility.HtmlEncode(Convert.ToString(order.Rows[i]["CourierName"])) + @"' data-Code='" + HttpUtility.HtmlEncode(Convert.ToString(order.Rows[i]["TrackingCode"])) + @"' data-Link='" + HttpUtility.HtmlEncode(Convert.ToString(order.Rows[i]["TrackingLink"])) + @"'  class='ViewShippingDetails fs-18 link-secondary bs-tooltip' data-bs-toggle='tooltip' data-placement='top' title='Deliver info'><i class='mdi mdi-truck-fast'></i></a>
                                    </td>
                                    <td class='text-center'><a href='javascript:void(0);' data-date='"+ Convert.ToString(order.Rows[i]["DeliveryDate"]) + "' data-status='"+ OrderStatus + @"' data-id='" + OrderGuid + @"' class='DeliveryDate fs-18 link-warning bs-tooltip' data-bs-toggle='tooltip' data-placement='top' title='Add Deliver Date'><i class='mdi mdi-timetable'></i></a></td>
                                    ...
                                    <td class='fixed-column'> 
                                        <a href='javascript:void(0);' class='bs-tooltip fs-18 link-primary dispatchItem' data-id='" + OrderGuid + @"' data-status='" + OrderStatus + @"' data-bs-toggle='tooltip' data-placement='top' title='Dispatch Order'><i class='ri-truck-line'></i></a>
                                        <a href='javascript:void(0);' class='bs-tooltip fs-18 link-success deliverItem' data-id='" + OrderGuid + @"' data-status='" + OrderStatus + @"' data-bs-toggle='tooltip' data-placement='top' title='Deliver Order'><i class='ri-checkbox-circle-line'></i></a>
                                        <a href='javascript:void(0);' class='bs-tooltip fs-18 link-danger cancelItem' data-id='" + OrderGuid + @"' data-status='" + OrderStatus + @"' data-bs-toggle='tooltip' data-placement='top' title='Cancel Order'><i class='ri-close-circle-line'></i></a>
    ...
    [WebMethod(EnableSession = true)]
    public static string DispatchOrder(string OrderGuid, string courierName, string trackingCode, string trackingLink, string oStatus)
    {
        string x = "";
        try
        {
            ...
            if (oDetails.Rows.Count > 0)
            {
                if (Convert.ToString(oDetails.Rows[0]["OrderStatus"]) != "Dispatched")
                {
                    ...
                    int exec = 0;
                    exec = Reports.DispatchOrder(conAP, OrderGuid, courierName, trackingCode, trackingLink, oStatus, UpdatedOn, UpdatedIP);
                    if (exec > 0)
                    {
    ...
    [WebMethod(EnableSession = true)]
    public static string UpdateDeliveryDate(string OrderGuid, string delDate)
    {
        string x = "";
        try
        {
            ...
            if (oDetails.Rows.Count > 0)
            {
                ...
                int exec = Reports.UpdateDeliveryDate(conAP, OrderGuid, delDate, UpdatedOn, UpdatedIP);
                if (exec > 0)
                {
                    x = "Success";
                }
