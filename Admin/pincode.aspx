                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <asp:TextBox runat="server" MaxLength="6" class="form-control mb-2 mr-sm-2 onlyNum" ID="txtCategory" />
                                ...
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpValidator3" runat="server" ErrorMessage="Enter a valid Name." ValidationExpression="^[a-zA-Z ]*$" ControlToValidate="txtcity" ValidationGroup="Contact" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                                </div>
