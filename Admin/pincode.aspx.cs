    ...
    public void GetPincode()
    {
        try
        {
            ...
            if (categories.Count > 0)
            {
                ...
                txtCategory.Text = categories[0].Pincode;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (Page.IsValid)
            {
                ...
                cat.Pincode = txtCategory.Text.Trim();
                ...
                List<PinCode> res = PinCode.GetPincodeByPinCode(conAP, txtCategory.Text.Trim());//.Where(s => s.Pincode.ToLower() == txtCategory.Text.Trim().ToLower()).ToList();
                    ...
                    if (CreateUser.CheckAccess(conAP, pageName, "Add", Request.Cookies["ap_aid"].Value))
                    {
                        ...
                        else
                        {
                            ...
                            if (result > 0)
                            {
                                ...
                                txtCategory.Text = txtcity.Text = txtShip.Text = "";
                            }
                            else
                            {
