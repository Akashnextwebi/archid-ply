    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (Page.IsValid)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "Snackbar.show({pos: 'top-right',text: 'Thumb image size should be 1600*700 px',actionTextColor: '#fff',backgroundColor: '#ea1c1c'});", true);
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "Snackbar.show({pos: 'top-right',text: 'Detail image size should be 1600*510 px',actionTextColor: '#fff',backgroundColor: '#ea1c1c'});", true);
