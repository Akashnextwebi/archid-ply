                                                                    ...
                                                                    <table border='0' cellpadding='0' cellspacing='0' style='float:left;width: 100%;margin-right:5%'>
                                                                        <tr>
                                                                            <td align='left' valign='top' width='48%' style='vertical-align: middle;' class='flexibleContainerCell'>
                                                                                <img style='width:110px;margin-bottom:0px;' src='/assets/imgs/logo.png' />
                                                                            </td>
...
<body bgcolor='#E1E1E1' leftmargin='0' marginwidth='0' topmargin='0' marginheight='0' offset='0'>
    ...
    public static async Task<int> ConsultRequest(Consult con)
    {
        try
        {
            MailMessage mail = new MailMessage();
    ...
    public static async Task<int> SellerRequest(Vendor con)
    {
        try
        {
            MailMessage mail = new MailMessage();
...
<body bgcolor='#E1E1E1' leftmargin='0' marginwidth='0' topmargin='0' marginheight='0' offset='0'>
    ...
    public static int SendEnquiryRequestToAdmin(string name, string MobileNo, string email, string products, string message)
    {
        try
        {
