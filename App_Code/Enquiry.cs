...
public class Enquiry
{
    ...
    public static int InserEnquiry(SqlConnection conAP, Enquiry enquiry)
    {
        ...
        try
        {
            string query = "Insert Into Enquiry (ProductType,Products,UserName,Email,Phone,Message,AddedOn,AddedIp,Status) values(@ProductType,@Products,@UserName,@Email,@Phone,@Message,@AddedOn,@AddedIp,@Status)";
            using (SqlCommand cmd = new SqlCommand(query, conAP))
            {
