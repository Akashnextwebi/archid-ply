...
public class Reports
{
    ...
    public static int DispatchOrder(SqlConnection _conn, string oGuid, string cName, string trkCode, string cLink, string Status, DateTime addedon, string addedip)
    {
        int x = 0;
        try
        {
            SqlCommand cmd = new SqlCommand("Update Orders Set OrderStatus=@OrderStatus, LastUpdatedOn=@LastUpdatedOn, CourierName=@CourierName, TrackingCode=@TrackingCode, TrackingLink=@TrackingLink, LastUpdatedIp=@LastUpdatedIp Where OrderGuid=@id and OrderStatus='In-Process'", _conn);
    ...
    public static int UpdateDeliveryDate(SqlConnection _conn, string oGuid, string delDate, DateTime addedon, string addedip)
    {
        int x = 0;
        try
        {
            SqlCommand cmd = new SqlCommand("Update Orders Set DeliveryDate=@DeliveryDate, LastUpdatedOn=@LastUpdatedOn, LastUpdatedIp=@LastUpdatedIp Where OrderGuid=@id", _conn);
            cmd.Parameters.AddWithValue("@id", SqlDbType.NVarChar).Value = oGuid;
