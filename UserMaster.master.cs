...
public partial class UserMaster : System.Web.UI.MasterPage
{
    ...
    public string strDeskMenu, strMobMenu, strpureply, strUserLoggedIn, strUserLoggedOut, strFooterCat, strFooterbrand, strUserLoginStatus, strGurjan, strdec, strlam, strviva = "";
            ...
            if (Request.Cookies["arch_i"] == null)
            {
                strUserLoginStatus = @"<div class='px-5 d-none d-xl-inline-block'>
                                        <a class='lh-1 color-inherit text-decoration-none'
                                            href='javascript:void(0)' data-bs-toggle='modal' data-bs-target='#signInModal'>
