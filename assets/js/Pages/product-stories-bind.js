...
$(document).ready(function () {
 ...
 data-bg-src='${img}'>
<a href='${product.Link}' class='view-video iframe-link video-btn d-flex justify-content-center align-items-center fs-30px lh-115px btn btn-outline-light border border-white border-2 rounded-circle transition-all-1'><svg class='icon'><use xlink:href='#icon-play-fill'></use></svg></a></div>` : `<a href='${img}' data-gallery='gallery7' data-thumb-src='${img}'><img style='height:355px !important' src='${img}' data-src='${img}' class='img-fluid lazy-image h-auto' alt=''></a>`

                    const StoreImg = product.StoriesGal?.map(gal => `<a href='/${gal.Images}' data-gallery='${gal.StoryGuid}' data-thumb-src='/${gal.Images}'><img style='height:355px !important' src='/${gal.Images}' data-src='/${gal.Images}' class='img-fluid lazy-image h-auto' alt=''></a>` ).join("") || "";
