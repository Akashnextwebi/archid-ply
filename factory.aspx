    ...
    <main id="content" class="wrapper layout-page">
        ...
        <section class="position-relative custom-overlay" id="about_introduction">
            ...
            <div class="position-relative z-index-2 container py-15 py-lg-22">
                ...
                <h2 class="fs-56px mb-0 text-white text-center">Factory</h2>
            </div>
        </section>
                            ...
                            <div class="position-relative">
                                <div class="position-absolute z-index-2 w-100 d-flex justify-content-end">
                                    <div class="p-6">
                                        ...
                                        <a href="/shop" class="d-flex align-items-center justify-content-center mt-5 product-gallery-action rounded-circle" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Compare">
                                            <svg class="icon fs-4">
        ...
        <div id="offCanvasNavBar" class="offcanvas offcanvas-start" style="--bs-offcanvas-width: 310px">
            ...
            <div class="offcanvas-body pt-0 mb-2">
                <ul class="navbar-nav">
                    ...
                    <li>
                        <a href="/" class="border-hover text-decoration-none fw-semibold py-3 d-block"><span class="border-hover-target">HOME </span></a>
                    </li>
