<%@ Page Title="" Language="C#" MasterPageFile="~/DashBoard.master" AutoEventWireup="true" CodeFile="order-detail.aspx.cs" Inherits="order_detail" %>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 ml-auto d-flex justify-content-md-end flex-wrap">
                        <div class="mw-210 me-5 my-3">
                            <select class="form-select" fdprocessedid="osp34g">
                ...
                <div class="row">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center flex-nowrap">
                                                <a href="../shop/product-details-v1.html" title="Flowers cotton dress">
                                                    <img src="../assets/images/products/product-03-75x100.jpg" data-src="../assets/images/products/product-03-75x100.jpg" alt="Flowers cotton dress" class="loaded" width="60" height="80" loading="lazy" data-ll-status="loaded">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center flex-nowrap">
                                                <a href="../shop/product-details-v1.html" title="Hoodie with pocket">
                                                    <img src="../assets/images/products/product-04-75x100.jpg" data-src="../assets/images/products/product-04-75x100.jpg" alt="Hoodie with pocket" class="loaded" width="60" height="80" loading="lazy" data-ll-status="loaded">
                                                </a>
                                                <a href="../shop/product-details-v1.html" title="Hoodie with pocket" class="ms-6">
                                                    <p class="fw-semibold text-body-emphasis mb-0">Hoodie with pocket</p>
                                                </a>
                                            </div>
                                        </td>
                                        <td>$7.50</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center flex-nowrap">
                                                <a href="../shop/product-details-v1.html" title="Oversize cotton sweatshirt">
                                                    <img src="../assets/images/products/product-06-75x100.jpg" data-src="../assets/images/products/product-06-75x100.jpg" alt="Oversize cotton sweatshirt" class="loaded" width="60" height="80" loading="lazy" data-ll-status="loaded">
                                                </a>
                                                <a href="../shop/product-details-v1.html" title="Oversize cotton sweatshirt" class="ms-6">
                                                    <p class="fw-semibold text-body-emphasis mb-0">Oversize cotton sweatshirt</p>
                                                </a>
                                            </div>
                                        </td>
                                        <td>$43.50</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center flex-nowrap">
                                                <a href="../shop/product-details-v1.html" title="Striped cotton-blend sweatshirt">
                                                    <img src="../assets/images/products/product-09-75x100.jpg" data-src="../assets/images/products/product-09-75x100.jpg" alt="Striped cotton-blend sweatshirt" class="loaded" width="60" height="80" loading="lazy" data-ll-status="loaded">
                                                </a>
                                                <a href="../shop/product-details-v1.html" title="Striped cotton-blend sweatshirt" class="ms-6">
                                                    <p class="fw-semibold text-body-emphasis mb-0">Striped cotton-blend sweatshirt</p>
                                                </a>
                                            </div>
                                        </td>
                                        <td>$99.00</td>
                                            ...
                                            <div class="d-flex flex-column align-items-end justify-content-end">
                                                <div class="mw-40 w-40">
                                                    ...
                                                    <div class="d-flex w-100 mb-5">
                                                        ...
                                                        <span class="d-inline-block w-50 text-end fs-5 fw-semibold">$983.00</span>
                                                    </div>
                                                    <div class="d-flex w-100">
                    ...
                    <div class="col-lg-4 offset-lg-1">
                        ...
                        <div class="h-25 pt-8">
                            ...
                            <button class="btn btn-primary" fdprocessedid="wl4pq9">Save note</button>
                        </div>
                    </div>
