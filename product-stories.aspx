<%@ Page Title="" Language="C#" MasterPageFile="./UserMaster.master" AutoEventWireup="true" CodeFile="product-stories.aspx.cs" Inherits="product_stories" %>
    ...
    <main id="content" class="wrapper layout-page">
        <section class="position-relative custom-overlay" id="about_introduction">
            ...
            <div class="position-relative z-index-2 container py-15 py-lg-22">
                ...
                <h2 class="fs-56px mb-0 text-white text-center">Product Stories
                </h2>
            </div>
        </section>
    </main>
