...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <main id="content" class="wrapper layout-page product-category">
        <section class="position-relative custom-overlay" id="about_introduction" style="height: 300px">
            <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100  light-mode-img" data-bg-src="/assets/imgs/inner-banner.jpg">
            </div>
        </section>
        <div class="container">
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-md-5">
                        <div class="text-center" data-animate="fadeInUp">
                            <h2 class="mb-6"><%=strHeading %></h2>
                            <p class="fs-18px w-lg-60 w-xl-80 mx-md-16 mx-lg-auto mb-13"><%=strCategoryDesc %></p>
                        </div>
                    </div>
                    <div class="col-md-7">
