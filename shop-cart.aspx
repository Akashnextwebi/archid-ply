<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="shop-cart.aspx.cs" Inherits="shop_cart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <main id="content" class="wrapper layout-page pb-15" style="background: #fbf1e9">
        ...
        <section class="container">
            <h2 class="text-center mt-4 mb-7">Shopping Cart</h2>
            <div class="shopping-cart bg-white">
                <center>
                    <div class="divNoItem">
                        <img src="/images_/empty-cart.gif"   width="200" height="200"/>
                ...
                <div class="row pt-8 pt-lg-11 pb-16 pb-lg-15 justify-content-center">
                    <div class="col-lg-4 pt-lg-0 pt-10 pricecard">
                        <div class="card border-0  mr-xl-11" style="box-shadow: 0 0 10px 0 rgba(0,0,0,0.1)">
