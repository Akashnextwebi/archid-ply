    ...
    <main id="content" class="wrapper layout-page">
        ...
        <section class="container pt-6 pb-13 pb-lg-20">
            ...
            <div class="row justify-content-center mt-2">
                ...
                <div class="col-md-5 pt-md-0 pt-10">
                        ...
                        <ul class="list-unstyled">
                            <div class="row gy-15px align-items-center spacing-02">
                                ...
                                <div class="col-auto dropdown skin-goal px-4">
                                    ...
                                    <select name="image_video" id="ddlThickness" class="form-select">
                                    </select>
                            ...
                            <div class="row align-items-end">
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="input-group position-relative w-100 input-group-lg">
                                        ...
                                        <input name="quantity" readonly id="product_quantity" class="form-control form-control-sm px-10 py-4 fs-6 text-center border-0 input-number qty-input" value="1" required="">
                                ...
                                <div class="col-sm-8 pt-9 mt-2 mt-sm-0 pt-sm-0">
                                    <button type="submit" class="btn-hover-bg-primary btn-hover-border-primary btn btn-lg btn-dark w-100 btnAddToCartP">
                                        Add To Bag
                                   
                                    </button>
                                    <a class="btn-hover-bg-primary btn-hover-border-primary btn btn-lg btn-dark w-100 Enquirybtn d-none" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">Quick Enquiry
                                    </a>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                <div class="pt-8 pb-3">
                                    ...
                                    <br />
                                    <asp:Button ID="SubmitButton" runat="server" CssClass="btn btn-dark btn-hover-bg-primary btn-hover-border-primary px-11 submitbtn" Text="Submit" OnClick="EnquiryButton_Click" />
                                </div>
                            </div>
                        </div>
