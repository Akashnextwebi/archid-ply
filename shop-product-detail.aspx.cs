...
public partial class shop_product_detail : System.Web.UI.Page
{
    ...
    public void bindProduct()
    {
        try
        {
            ...
            if (Prod.Count > 0)
            {
                ...
                {
                    strProdStatus = "<span class='ItemAvailable'>Sale</span>";
                }
                else
                {
                    strProdStatus = "<span class='ItemNotAvailable'>Sold Out</span>";
                }
    ...
    public void BindReviews()
    {
        try
        {
            ...
            {
                strReatings += @"<div class='border-bottom pb-7 pt-10'><h3 class=''>No reviews found for this product yet. Be the first to <span><a href='#customer-review' data-bs-toggle='collapse' role='button' aria-expanded='false' aria-controls='customer-review'>write a review!</a></span></h3></div>";
            }
        }
        catch (Exception ex)
        {
...
<div class='pt-15 pt-lg-18'>
	<div class='row'>
              <div class='text-center'><h2 class='fs-36px mb-11 mb-lg-14'>Frequently Asked Questions</h2></div>
		<div class='col-md-12'>
