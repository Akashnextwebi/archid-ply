<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="shop-products.aspx.cs" Inherits="shop_products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <main id="content" class="wrapper layout-page product-category">
        ...
        <section class="position-relative custom-overlay" id="about_introduction">
            ...
            <div class="position-relative z-index-2 container  pt-lg-22 pb-lg-22">

                <h2 class="fs-56px mb-0 text-white text-center CatName">All Our Products</h2>
            </div>
        </section>
        <section class="shop-product-layout" style="background: #F1EFEC url('assets/imgs/bg-img3.png'); background-repeat: no-repeat; background-position: left; background-attachment: fixed">
            ...
            <center>
                <div class="container container-xxl pb-16 pb-lg-18 mb-lg-3 pt-0  mt-10 divNoItem">
                    <img src="/images_/not-found.png" width="300" height="300" />
            ...
            <div class="container container-xxl pb-16 pb-lg-18 mb-lg-3 pt-0 mainProductList">
