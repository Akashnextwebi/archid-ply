  ...
  "arrows": false,
            ...
            <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
                <div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
                    <a href="index.html" class="navbar-brand py-4 d-lg-inline-block">
                        <img src="assets/imgs/logo.png" height="46" alt="Archidply Decor">
                    </a>
                </div>
    ...
    <div id="shoppingCart" data-bs-scroll="false" class="offcanvas offcanvas-end">
        ...
        <div class="offcanvas-footer flex-wrap">
            ...
            <a href="https://templates.g5plus.net/shop/shop-checkout.aspx" class="btn btn-dark w-100 mb-7" title="Check Out">Check Out</a>
                ...
                <div class="modal-body px-sm-13 px-8">
                    ...
                    <form action="#">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-8 mb-7">
                            ...
                            <a href="forgot-password.aspx" class="text-secondary">Forgot your password?</a>
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6 pt-md-0 pt-10">
                            ...
                            <h1 class="mb-4 pb-2 fs-4">
                                <a href="shop/product-details-v1.html" title="Natural Coconut Cleansing Oil">Natural Coconut Cleansing Oil
                                </a>
                            </h1>
    ...
    <div class="navbar">
        <div id="offCanvasNavBar" class="offcanvas offcanvas-start" style="--bs-offcanvas-width: 310px">
            ...
            <div class="offcanvas-header bg-body-tertiary">
                <h4 class="offcanvas-title text-uppercase">Archidply Decor</h4>
            ...
            <div class="offcanvas-body pt-0 mb-2">
                <ul class="navbar-nav">
                    ...
                    <li>
                        <a href="index.html" class="border-hover text-decoration-none fw-semibold py-3 d-block"><span class="border-hover-target">HOME </span></a>
                    </li>


                    <li>
                        <a href="about-us" class="border-hover text-decoration-none fw-semibold py-3 d-block"><span class="border-hover-target">ABOUT US </span></a>
                    </li>
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth position-static">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle"
                            href="store.html" data-bs-toggle="dropdown" id="menu-item-shop-canvas" aria-haspopup="true" aria-expanded="false">OUR PRODUCTS</a><div class="dropdown-menu mega-menu start-0 py-6  w-100"
                    ...
                    <li>
                        <a href="shop-products.aspx" class="border-hover text-decoration-none fw-semibold py-3 d-block"><span class="border-hover-target">SHOP </span></a>
                    </li>


                    <li>
                        <a href="investors.aspx" class="border-hover text-decoration-none fw-semibold py-3 d-block"><span class="border-hover-target">INVESTORS </span></a>
                    </li>
        ...
        <div class="modal-dialog certi-modal modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-13 px-8 pt-0">
                    ...
                    <p>Mrs. Akshatha Rai Presently leading the hospitality Department of Raineo Group has completed her Bachelor of Dental Surgery from ABSMIDS, Rajiv Gandhi University in 2002. After participating Dental Science for a couple of years she joined Raineo Group as G.M (Admin) with a decade of experience in business management,   </p>
                    <p>
